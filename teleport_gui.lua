-- Full Teleport GUI Script with teleport point cleanup
...
-- Button factory with text stroke
...
-- Notification frame (high ZIndex)
...
notifShadow.Position = UDim2.new(0,0,0,0)
notifShadow.AnchorPoint = Vector2.new(0,0)
notifShadow.ImageTransparency = 0.6
notifShadow.BackgroundTransparency = 1
notifShadow.ZIndex = 1999
...
-- Find inventory GUI (best effort)
